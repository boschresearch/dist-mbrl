...
class ModelEnv:
    ...
    def __init__(
        ...
        reward_fn: Optional[dist_mbrl.mbrl.types.RewardFnType] = None,
    ...
    def reset(
        ...
        """
        if isinstance(
            self.dynamics_model, dist_mbrl.mbrl.models.OneDTransitionRewardModel
        ):
    ...
    def step(
        self,
        actions: dist_mbrl.mbrl.types.TensorType,
        model_state: Dict[str, torch.Tensor],
        sample: bool = False,
    ) -> Tuple[
        dist_mbrl.mbrl.types.TensorType,
        dist_mbrl.mbrl.types.TensorType,
        np.ndarray,
        Dict,
    ]:
