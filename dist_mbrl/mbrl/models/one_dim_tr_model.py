...
import dist_mbrl.mbrl.models.util as model_util
...
class OneDTransitionRewardModel(Model):
    ...
    def __init__(
        ...
        obs_process_fn: Optional[dist_mbrl.mbrl.types.ObsProcessFnType] = None,
        no_delta_list: Optional[List[int]] = None,
        num_elites: Optional[int] = None,
    ):
        super().__init__(model.device)
        self.model = model
        self.input_normalizer: Optional[dist_mbrl.mbrl.util.math.Normalizer] = None
        if normalize:
            self.input_normalizer = dist_mbrl.mbrl.util.math.Normalizer(
                self.model.in_size,
                self.model.device,
    ...
    def _get_model_input(
        self,
        obs: dist_mbrl.mbrl.types.TensorType,
        action: dist_mbrl.mbrl.types.TensorType,
    ) -> torch.Tensor:
    ...
    def _process_batch(
        self, batch: dist_mbrl.mbrl.types.TransitionBatch, _as_float: bool = False
    ...
    def update_normalizer(self, batch: dist_mbrl.mbrl.types.TransitionBatch):
    ...
    def loss(
        self,
        batch: dist_mbrl.mbrl.types.TransitionBatch,
    ...
    def get_output_and_targets(
        self, batch: dist_mbrl.mbrl.types.TransitionBatch
